...
esri.layers.Layer = function (options) {
  ...
  /// <field name="url" type="String">URL to the ArcGIS Server REST resource that represents a map service.  To obtain the URL, use Services Directory.  An example URL for the Street Map service on ArcGIS Online is:   https://server.arcgisonline.com/ArcGIS/rest/services/ESRI_StreetMap_World_2D/MapServer.</field>
...
esri.geometry.getLineIntersection = function (
  line1start,
  line1end,
  line2start,
  line2end
...
esri.geometry.toScreenGeometry = function (
  extent,
  width,
  height,
  screenGeometry
...
esri.geometry.normalizeCentralMeridian = function (
  geometries,
  geometryService,
  callback,
  errback
...
esri.tasks.ImageServiceIdentifyTask = function (url) {
  ...
  /// <param name="url" type="String" optional="false">URL to the ArcGIS Server REST resource that represents an image service.var imageTask = new esri.tasks.ImageServiceIdentifyTask("https://servicesbeta.esri.com/ArcGIS/rest/services/Portland/PortlandAerial/ImageServer");</param>
};
...
esri.dijit.TimeSlider.prototype = {
  ...
  createTimeStopsByTimeInterval: function (
    timeExtent,
    timeInterval,
    timeIntervalUnits
  ) {
...
esri.renderer.UniqueValueRenderer = function (
  defaultSymbol,
  attributeField,
  attributeField2,
  attributeField3,
...
esri.renderer.TemporalRenderer = function (
  observationRenderer,
...
esri.virtualearth.VETiledLayer = function (options) {
  ...
  /// <field name="culture" type="String">Specifies the culture in which to return results. The default value is "en-US". For a list of supported cultures, see https://msdn.microsoft.com/en-us/library/cc981048.aspx.</field>
...
esri.virtualearth.VEGeocodeResult = function () {
  ...
  /// <field name="calculationMethod" type="String">Contains values that indicate the geocode method used to match the location to the map. The values are "Interpolation", "Parcel", and "Rooftop".  For more information see https://msdn.microsoft.com/en-us/library/cc980868.aspx under "Match Methods".</field>
  ...
  /// <field name="entityType" type="String">Further refines the geocode results that have been returned. For more details on entities and a list of entities that are returned see, https://msdn.microsoft.com/en-us/library/cc981001.aspx.</field>
  /// <field name="location" type="Point">The X and Y coordinates of the result in decimal degrees.</field>
  /// <field name="matchCodes" type="String">An array of values that indicate the geocoding level of the location match. For more information and a list of values, see https://msdn.microsoft.com/en-us/library/cc980868.aspx.</field>
};
...
esri.arcgis.utils = function () {
  ...
  /// <field name="esri.arcgis.utils.arcgisUrl" type="String">Specify the domain where the map associated with the webmap id is located. The default value is https://www.arcgis.com/sharing/content/items</field>
};
