...
function init() {
  ...
  var predictionLocations = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: true,
  ...
  var reservationBounds = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
  ...
  var pitMinePoly = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "pitMinePoly",
  ...
  var WTContours = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "WTContours",
  ...
  /*var streamflow = new esri.layers.ArcGISDynamicMapServiceLayer("https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer", { 
		"visible": false,
		id: 'streamflow'
	});
  ...
  legendLayers.push({
    layer: reservationBounds,
    title: "Bad River Reservation Boundary",
  });
  legendLayers.push({ layer: pitMinePoly, title: "Proposed Mining Location" });
  legendLayers.push({
    layer: predictionLocations,
    title:
      "Model Prediction Locations (Click a location marker on the map to view New Data Worth for each prediction).",
  });
  ...
  checkBoxDisplay.push({
    layer: pitMinePoly,
    title: "Proposed Mining Location",
  });
  ...
  var drawDown1Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "drawDown1",
  ...
  legendLayers.push({
    layer: drawDown1Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels Prediction1",
  });

  var drawDown2Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "drawDown2",
  ...
  legendLayers.push({
    layer: drawDown2Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels Prediction2",
  });

  var drawDown3Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "drawDown3",
  ...
  legendLayers.push({
    layer: drawDown3Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels Prediction3",
  });

  var fishHatchPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "fishHatch",
  ...
  legendLayers.push({
    layer: fishHatchPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Water level in artesian well at Bad River Fish Hatchery",
  });

  var resSwPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "resSw",
  ...
  legendLayers.push({
    layer: resSwPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels at southwest corner of reservation",
  });

  var resSePoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "resSe",
  ...
  legendLayers.push({
    layer: resSePoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels at southeast corner of reservation",
  });

  var resSPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "resS",
  ...
  legendLayers.push({
    layer: resSPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels near middle part of southern reservation boundary",
  });

  var carolinePoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "caroline",
  ...
  legendLayers.push({
    layer: carolinePoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels near Caroline Lake",
  });

  var obrienPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "obrien",
  ...
  legendLayers.push({
    layer: obrienPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels near O'brien Lake",
  });

  var mccarthyPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "mccarthy",
  ...
  legendLayers.push({
    layer: mccarthyPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels near McCarthy Lake",
  });

  var bad169Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "bad169",
  ...
  legendLayers.push({
    layer: bad169Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Bad River baseflow at highway 169",
  });

  var tyGehrmanPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "tyGehrman",
  ...
  legendLayers.push({
    layer: tyGehrmanPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Tyler Forks baseflow above confluence with Gehrman Creek",
  });

  var spbrkBrunsPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "spbrkBruns",
  ...
  legendLayers.push({
    layer: spbrkBrunsPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Spring Brook Creek above confluence with Brunsweiler River",
  });

  var prenticeParkPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "prenticePark",
  ...
  legendLayers.push({
    layer: prenticeParkPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Water levels in artesian wells at Prentice Park",
  });

  var minersvilleAPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "minersvileA",
  ...
  legendLayers.push({
    layer: minersvilleAPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Water levels in artesian well at Minersville",
  });

  var bf121Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "bf121",
  ...
  legendLayers.push({
    layer: bf121Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Water levels near Mellen municipal well",
  });

  var graveyardPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "graveyard",
  ...
  legendLayers.push({
    layer: graveyardPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Graveyard Creek baseflow, USGS site 4027689",
  });

  var winksGurneyPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "winksGurney",
  ...
  legendLayers.push({
    layer: winksGurneyPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Spring flow to Winks Creek near Gurney, WI, USGS site 4026911",
  });

  var potatoUpson59Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "potatoUpson59",
  ...
  legendLayers.push({
    layer: potatoUpson59Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Potato River baseflow near Upson, WI, USGS site 4026859",
  });

  var tylerMoorePoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "tylerMoore",
  ...
  legendLayers.push({
    layer: tylerMoorePoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Tyler Forks baseflow at Moore Park Rd.",
  });

  var tylerFork61Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "tylerFork61",
  ...
  legendLayers.push({
    layer: tylerFork61Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Tyler Forks baseflow at Stricker Rd., USGS site 4026561",
  });

  var badMellenPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "badMellen",
  ...
  legendLayers.push({
    layer: badMellenPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Bad River baseflow near Mellen, WI, USGS site 4026450",
  });

  var cityMellenPoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "cityMellen",
  ...
  legendLayers.push({
    layer: cityMellenPoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting City Creek baseflow, USGS site 40265095",
  });

  var potatoGurney10Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "potatoGurney10",
  ...
  legendLayers.push({
    layer: potatoGurney10Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Potato River baseflow near Gurney, WI, USGS site 4026910",
  });

  var potatoGurney00Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "potatoGurney00",
  ...
  legendLayers.push({
    layer: potatoGurney00Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Potato River baseflow near Gurney, WI, USGS site 4026900",
  });

  var potatoUpson80Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "potatoUpson80",
  ...
  legendLayers.push({
    layer: potatoUpson80Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Potato River baseflow near Upson, WI, USGS site 4026880",
  });

  var tylerForks30Points = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "tylerForks30",
  ...
  legendLayers.push({
    layer: tylerForks30Points,
    title:
      "New Data Worth for reducing model uncertainty in predicting Tyler Forks baseflow near Caroline Lake Rd., USGS site 4026530",
  });

  var badMorsePoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "badMorse",
  ...
  legendLayers.push({
    layer: badMorsePoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Bad River baseflow near Morse, WI, USGS site 4026410",
  });

  var minnowMorsePoints = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PREDUNC_results_No_Raster/MapServer",
    {
      visible: false,
      id: "minnowMorse",
  ...
  legendLayers.push({
    layer: minnowMorsePoints,
    title:
      "New Data Worth for reducing model uncertainty in predicting Minnow Creek baseflow near Morse, WI, USGS site 4026413",
  });

  //BEGIN THE RASTER DECLARATIONS
  var drawDown1Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
      id: "drawDown1Raster",
  ...
  legendLayers.push({
    layer: drawDown1Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels Prediction 1",
  });

  var drawDown2Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: drawDown2Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels Prediction 2",
  });

  var drawDown3Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: drawDown3Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels Prediction 3",
  });

  var fishHatchRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: fishHatchRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Water level in artesian well at Bad River Fish Hatchery",
  });

  var resSwRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  var resSeRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  var resSRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  var carolineRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: carolineRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels near Caroline Lake",
  });

  var obrienRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  var mccarthyRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: mccarthyRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Groundwater levels near McCarthy Lake",
  });

  var bad169Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  var tyGehrmanRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: tyGehrmanRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Tyler Forks baseflow above confluence with Gehrman Creek",
  });

  var spbrkBrunsRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: spbrkBrunsRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Spring Brook Creek above confluence with Brunsweiler River",
  });

  var prenticeParkRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: prenticeParkRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Water levels in artesian wells at Prentice Park",
  });

  var minersvilleARaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: minersvilleARaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Water levels in artesian well at Minersville",
  });

  var bf121Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  var graveyardRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: graveyardRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Graveyard Creek baseflow, USGS site 4027689",
  });

  var winksGurneyRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: winksGurneyRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Spring flow to Winks Creek near Gurney, WI, USGS site 4026911",
  });

  var potatoUpson59Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: potatoUpson59Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Potato River baseflow near Upson, WI, USGS site 4026859",
  });

  var tylerMooreRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: tylerMooreRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Tyler Forks baseflow at Moore Park Rd.",
  });

  var tylerFork61Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: tylerFork61Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Tyler Forks baseflow at Stricker Rd., USGS site 4026561",
  });

  var badMellenRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: badMellenRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Bad River baseflow near Mellen, WI, USGS site 4026450",
  });

  var cityMellenRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: cityMellenRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting City Creek baseflow, USGS site 40265095",
  });

  var potatoGurney10Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: potatoGurney10Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Potato River baseflow near Gurney, WI, USGS site 4026910",
  });

  var potatoGurney00Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: potatoGurney00Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Potato River baseflow near Gurney, WI, USGS site 4026900",
  });

  var potatoUpson80Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: potatoUpson80Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Potato River baseflow near Upson, WI, USGS site 4026880",
  });

  var tylerForks30Raster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: tylerForks30Raster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Tyler Forks baseflow near Caroline Lake Rd., USGS site 4026530",
  });

  var badMorseRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
  ...
  legendLayers.push({
    layer: badMorseRaster,
    title:
      "New Data Worth for reducing model uncertainty in predicting Bad River baseflow near Morse, WI, USGS site 4026410",
  });

  var minnowMorseRaster = new esri.layers.ArcGISDynamicMapServiceLayer(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer",
    {
      visible: false,
      opacity: 0.5,
    ...
    dojo.forEach(checkBoxDisplay, function (layer) {
      if (layer.checkBox !== "false") {
        ...
        if (layer.zoomScale) {
          ...
          zoomImage.innerHTML =
            '<img id="zoomImage" style="height: 18px;width: 18px" src="images/zoom.gif" />';
  ...
  identifyTaskRaster = new esri.tasks.IdentifyTask(
    "https://gis1.wim.usgs.gov/server/rest/services/BadRiver/PredictionRasters/MapServer"
  );
  ...
  identifyParamsRaster.layerOption =
    esri.tasks.IdentifyParameters.LAYER_OPTION_VISIBLE;
  ...
  document.getElementById("rasterButton").innerHTML =
    "Show Uncertainty Layer Surface";
...
function drawBox() {
  ...
  dojo.connect(tb, "onDrawEnd", function (extent) {
    var boxIdentifyTask = new esri.tasks.IdentifyTask(
      "https://gis1.wim.usgs.gov/server/rest/services/BadRiverGroundwaterMapper/BadRiverPredictions/MapServer"
    );
    var boxIdentifyParams = new esri.tasks.IdentifyParameters();
    boxIdentifyParams.layerIds = identifyLayersArr;
    boxIdentifyParams.layerOption =
      esri.tasks.IdentifyParameters.LAYER_OPTION_VISIBLE;
    ...
    if (Math.abs(drawBoxYmaxDiff) > Math.abs(drawBoxYminDiff)) {
      // have to take absolute values of these two values
      infoWindowPoint = new esri.geometry.Point(
        extent.xmax,
        extent.ymin,
